<?php
    if($tabella == 'responsabile') {
        ...
        if($_FILES['col1riga' . $i]["error"] == 0) {
            if($tabella == 'parco') {
                $txb1 = "Images/img_parchi/" . basename($_FILES['col1riga' . $i]['name']);
            } else if($tabella == 'fauna') {
                $txb1 = "Images/img_fauna/" . basename($_FILES['col1riga' . $i]['name']);
            } else if($tabella == 'flora') {
                if($tipo == 'albero') {
                    $txb1 = "Images/img_flora/Alberi/" . basename($_FILES['col1riga' . $i]['name']);
                } else if($tipo == 'arbusto') {
                    $txb1 = "Images/img_flora/Arbusti/" . basename($_FILES['col1riga' . $i]['name']);
                } else if($tipo == 'piantaErbacea') {
                    $txb1 = "Images/img_flora/PianteErbacee/" . basename($_FILES['col1riga' . $i]['name']);
                }
            }
