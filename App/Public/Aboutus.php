    ...
    <div class="container team-sektion paddingTB60">
        <div class="row">
            <div class="site-heading text-center">
                ...
                <p class="p-aboutus">Questi siamo noi! <div class="border"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 team-box">
                <div class="team-img thumbnail">
                    <img src="../../Images/img_aboutus/teo.jpeg">
                    <div class="team-content">
                        <h3 class="h3-aboutus">Toader Mirza</h3>
                        <div class="border-team"></div>
                        <p>Resposabile della parte grafica del sito e assistente principale di Tommaso Tosca</p>
                        <div class="social-icons">
                            ...
                            <a class="a-aboutus" href="https://plus.google.com/"><i id="social-gp" class="fa fa-google-plus-square fa-3x social i-aboutus"></i></a>
                            <a class="a-aboutus" href="mailto:bootsnipp@gmail.com"><i id="social-em" class="fa fa-envelope-square fa-3x social i-aboutus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 team-box">
                <div class="team-img thumbnail">
                    <img src="../../Images/img_aboutus/zuza.jpg">
                    <div class="team-content">
            ...
            <div class="col-md-4 team-box">
                <div class="team-img thumbnail">
                    <img src="../../Images/img_aboutus/tosca.jpeg">
                    <div class="team-content">
